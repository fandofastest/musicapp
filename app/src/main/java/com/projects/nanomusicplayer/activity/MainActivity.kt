package com.projects.nanomusicplayer.activity
...
import com.projects.nanomusicplayer.fragments.*
import com.projects.nanomusicplayer.interfaces.Playable
import com.projects.nanomusicplayer.services.OnClearFromRecentService
import com.projects.nanomusicplayer.uicomponents.RepeatTriStateButton
import com.projects.nanomusicplayer.viewmodel.allSongs.AllSongsViewModel
import com.projects.nanomusicplayer.viewmodel.allSongs.AllSongsViewModelFactory
import com.projects.nanomusicplayer.viewmodel.mediaControl.MediaControlViewModel
import com.projects.nanomusicplayer.viewmodel.playlists.PlaylistViewModel
import com.projects.nanomusicplayer.viewmodel.playlists.PlaylistViewModelFactory
import com.projects.nanomusicplayer.viewmodel.recentSongs.RecentSongsViewModel
import com.projects.nanomusicplayer.viewmodel.recentSongs.RecentSongsViewModelFactory
...
class MainActivity : AppCompatActivity(), Playable {
    ...
    lateinit var collapsedMusicCover: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        collapsedMusicCover = findViewById(R.id.b_sheet_CollapsedMusicCover)
        ...
        mMediaControlViewModel.nowPlayingSongs.observe(this, Observer {
            Log.i("PLAYLIST", "New playlist added $it")
            uiscope.launch {
        ...
        withContext(Dispatchers.Main) {
            ...
            try {
                ...
                Picasso.with(this@MainActivity).load(actualArtUri).error(R.drawable.d7)
                    .into(collapsedMusicCover)


            } catch (e: java.lang.Exception) {
                collapsedMusicCover.setImageResource(R.drawable.d7)
            }
        }
    }
